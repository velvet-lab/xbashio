...
# shellcheck source=./xbashio-core/src/const.sh
...
# Main Modules
# ==============================================================================
# shellcheck source=./xbashio-core/src/color.sh
source "${__XBASHIO_LIB_DIR}/color.sh"
# shellcheck source=./xbashio-core/src/var.sh
source "${__XBASHIO_LIB_DIR}/var.sh"
# shellcheck source=./xbashio-core/src/fs.sh
source "${__XBASHIO_LIB_DIR}/fs.sh"
# shellcheck source=./xbashio-core/src/log.sh
source "${__XBASHIO_LIB_DIR}/log.sh"
# shellcheck source=./xbashio-core/src/string.sh
source "${__XBASHIO_LIB_DIR}/string.sh"
# shellcheck source=./xbashio-core/src/exit.sh
source "${__XBASHIO_LIB_DIR}/exit.sh"
# shellcheck source=./xbashio-core/src/env.sh
